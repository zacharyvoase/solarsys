...
function exportGhosTTYDark(theme: SolarizedTheme, themeName: string): string {
  return `# ${themeName} theme for Ghostty
...
function exportGhosTTYLight(theme: SolarizedTheme, themeName: string): string {
  return `# ${themeName} theme for Ghostty
# Generated by SolarSystem
