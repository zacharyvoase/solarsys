...
function exportKittyDark(theme: SolarizedTheme, themeName: string): string {
  return `# ${themeName} theme for Kitty
...
function exportKittyLight(theme: SolarizedTheme, themeName: string): string {
  return `# ${themeName} theme for Kitty
# Generated by SolarSystem
